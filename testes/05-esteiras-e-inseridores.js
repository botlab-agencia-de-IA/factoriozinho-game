...
ok(movidos>=4 && movidos<=6,'moveu ~5 itens em 10s — moveu '+movidos);
...
const be1=World.criarEntidade('transport_belt',loc.x+2,loc.y,1);
World.criarEntidade('transport_belt',loc.x+3,loc.y,1);
const ins2=World.criarEntidade('inserter',loc.x+4,loc.y,1);
Inv.add(ins2.inv.fuel,'coal',20);
const fo=World.criarEntidade('stone_furnace',loc.x+5,loc.y,0);
Inv.add(fo.inv.fuel,'coal',20);
const ins3=World.criarEntidade('inserter',loc.x+7,loc.y,1);
Inv.add(ins3.inv.fuel,'coal',20);
const be3=World.criarEntidade('transport_belt',loc.x+8,loc.y,1);
